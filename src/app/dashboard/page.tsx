  ...
  return (
    <div className='flex min-h-screen w-full bg-muted/40'>
      <div className='max-w-7xl w-full mx-auto flex flex-col sm:gap-4 sm:py-4'>
        <div className='grid gap-4 sm:grid-cols-2'>
          <Card>
            <CardHeader className='pb-2'>
              <CardDescription>LastWeek</CardDescription>
        ...
        <h1 className='text-4xl font-bold tracking-tight py-4'>
          Incoming orders
        </h1>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className='hidden sm:table-cell'>Purchse date</TableHead>
              ...
              <TableRow key={order.id} className='bg-accent'>
                <TableCell>
                  <div className='font-medium'>
                    {order.shippingAddress?.name || '--unknow--'}
                  </div>
