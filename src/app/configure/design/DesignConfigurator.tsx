...
import { Radio, RadioGroup, Description, Label as RadioLabel } from '@headlessui/react'
...
import { BASE_PRICE } from '@/config/prodcts';
...
const DesignConfigurator = ({ configId, imageUrl, imageDimensions }: DesignConfiguratorProps) => {
  ...
  const [renderedDismension, setRenderedDimesion] = useState({
  ...
  async function saveConfiguration() {
    try {
      ...
      ctx?.drawImage(
        ...
        actualX,
        actualY,
        renderedDismension.width,
        renderedDismension.height
      )
    ...
    <div className='relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20'>
      ...
      <div className='h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white'>
        <ScrollArea className='relative flex-1 overflow-auto'>
          <div aria-hidden='true' className='absolute h-6 w-full top-0 left-0 z-10 backdrop:blur-md bg-gradient-to-t from-white pointer-events-none'/>
